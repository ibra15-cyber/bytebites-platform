...
//        orderPlacedEvent.setTotalAmount(BigDecimal.valueOf(29.99));
//
...
//
//        orderPlacedEvent.setOrderItems(Arrays.asList(item1, item2));
//
...
//        // Given
//        orderPlacedEvent.setOrderItems(null);
//        doNothing().when(mailSender).send(any(SimpleMailMessage.class));
//
//        // When
//        CompletableFuture<Void> result = emailService.sendCustomerOrderConfirmation(orderPlacedEvent);
...
//        // Given
//        orderPlacedEvent.setOrderItems(Arrays.asList());
//        doNothing().when(mailSender).send(any(SimpleMailMessage.class));
//
//        // When
//        CompletableFuture<Void> result = emailService.sendCustomerOrderConfirmation(orderPlacedEvent);
